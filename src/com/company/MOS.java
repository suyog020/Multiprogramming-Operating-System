...
public class MOS {
    ...
    MOS() {
        ...
        try {
            this.fReader = new BufferedReader(new FileReader("G:\\MOS\\src\\com\\company\\input.txt"));
        } catch (FileNotFoundException ex) {
            Logger.getLogger(MOS.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            this.fWriter = new BufferedWriter(new FileWriter("G:\\MOS\\src\\com\\company\\output.txt"));
